...
class WebTemp(object):
    ...
    def __init__(self):
        self.end = '''
            ...
            </body><div style="position: relative"><div style="font-size: 50%;">
                        <p  style="position: fixed; bottom: 0; width:100%; text-align: center">
                          <center><br><br>
                          CSS & Layout from <b><a href = "https://www.wix.com">www.WIX.com</a><b>
                          </center>
                        </p>
                    </div></div>
            </html>
        ...
        self.start = '''
            ...
            <meta http-equiv="X-Wix-Published-Version" content="52">

            <meta http-equiv="etag" content="49454e813236f853d28387fb9bb0bbdf">
            ...
            .fc1centeredContent {position:absolute;top:0;right:0;bottom:0;left:0;}</style><style type="text/css" data-reactid=".0.0.$hc1">.hc1screenWidthBackground {position:absolute;top:0;right:0;bottom:0;left:0;}
            ...
            .c1inlineContent,.c1bg {position:absolute;top:0;right:0;bottom:0;left:0;}</style><style type="text/css" data-reactid=".0.0.$txtNew">.txtNew {word-wrap:break-word;}
            ...
            .txtNew a {color:inherit;}</style><style type="text/css" data-reactid=".0.0.$wixAds">.wixAdsmobileAd {width:100%;height:30px;position:relative;display:block;text-align:center;background-color:#313131;z-index:999;}
