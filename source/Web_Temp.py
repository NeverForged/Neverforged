...
class WebTemp(object):
    ...
    def __init__(self):
        ...
        self.start = '''
            ...
            /* Change color of dropdown links on hover */
            .dropdownsk-content a:hover {color: white; background-color: black}

            /* Show the dropdown menu on hover */
            .dropdownsk:hover .dropdownsk-content {
                display: block;
            }

            /* Change the background color of the dropdown button when the dropdown content is shown */
            .dropdownsk:hover .dropbtn {
                background-color: #3e8e41;
            }
            ...
            /*# sourceMappingURL=viewer.css.map */</style>
        ...
        '''.replace('https://darinlasota.wixsite.com/mysite', 'http://localhost:8888')
